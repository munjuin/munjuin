...
| **Framework** | ![Express](https://img.shields.io/badge/-Express-000000?style=flat-square&logo=Express&logoColor=white) ![NestJS](https://img.shields.io/badge/-NestJS-E0234E?style=flat-square&logo=nestjs&logoColor=white) |
...
| **Tools** | ![Git](https://img.shields.io/badge/-Git-F05032?style=flat-square&logo=git&logoColor=white) ![NPM](https://img.shields.io/badge/-NPM-CB3837?style=flat-square&logo=npm&logoColor=white) ![Docker](https://img.shields.io/badge/-Docker-2496ED?style=flat-square&logo=Docker&logoColor=white) |
...
- [x] **Step 2. Type Safety**: 핵심 프로젝트(Jewelry Shop, Automator)의 **TypeScript 마이그레이션**
- [ ] **Step 3. Architecture Scaling**: NestJS의 DI/모듈화 구조 도입 및 로컬 AI 시스템의 확장성 강화
- [ ] **Step 4. Full-stack Integration**: React 연동 및 사용자 경험(UX) 고도화
